...
$StudioObjectives = @(
    ...
    @{ Key="gumroad-bundle";        Title="Promote Gumroad game bundle (\$4.99) — add marketing links"; Body="The \$4.99 game bundle exists at tdsquad.gumroad.com but needs promotion. Add 'Get the Bundle' CTAs in all game pages and the landing page." }
